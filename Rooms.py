...
class Rooms(Base):
    ...
    employee_requests: [Requests] = relationship("Requests", back_populates="room_requested", viewonly=False)
    ...
    def add_door_str(self, door_name: String):
    ...
    def add_request(self, request: Request):
        ...
        self.employee_requests.apppend(request)
